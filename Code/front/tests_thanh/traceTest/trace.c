...
static void do_trace(cairo_t *, GtkWidget *widget);
...
// Cette variable est globale pour des soucis de manipulation
cairo_t *monImg;
...
static void do_trace(cairo_t *cr, GtkWidget *widget)
{
