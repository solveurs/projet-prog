...
carte initCarte(char* chemin_image_carte, char* chemin_donnees_carte, int hauteur, int largeur, double latitudeHautGauche, double longitudeHautGauche, double latitudeBasDroite, double longitudeBasDroite)
{
  ...
  strcpy(res.chemin_image_carte, chemin_image_carte);
  strcpy(res.chemin_donnees_carte, chemin_donnees_carte);
...
/*
carte carte_Cher = initCarte("../../Data/cartes/carte_Cher.png","", 1850, 3506, 47.988083, 1.726227, 46.194092, 3.115997);
